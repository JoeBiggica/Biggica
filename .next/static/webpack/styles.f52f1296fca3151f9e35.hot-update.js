      ...
      if (window.__webpack_reload_css__) {
        ...
        document
          ...
          .forEach(function(link) {
            ...
            injectCss(link, link.href.split("?")[0] + "?unix=1565538732942");
          });
      }
    }
    ...
    if (true) {
      ...
      if (window.__webpack_reload_css__) {
        ...
        document
          ...
          .forEach(function(link) {
            if (!link.href.match(prefix) || link.stale) return;
            injectCss(link, link.href.split("?")[0] + "?unix=1565538732987");
          });
      }
    }
    ...
    if (true) {
      ...
      if (window.__webpack_reload_css__) {
        ...
        document
          ...
          .forEach(function(link) {
            if (!link.href.match(prefix) || link.stale) return;
            injectCss(link, link.href.split("?")[0] + "?unix=1565538732960");
          });
      }
    }
    ...
    if (true) {
      ...
      if (window.__webpack_reload_css__) {
        ...
        document
          ...
          .forEach(function(link) {
            if (!link.href.match(prefix) || link.stale) return;
            injectCss(link, link.href.split("?")[0] + "?unix=1565538733036");
          });
      }
    }
...
//# sourceMappingURL=styles.f52f1296fca3151f9e35.hot-update.js.map